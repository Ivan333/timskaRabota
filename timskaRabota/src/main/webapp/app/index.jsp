...
<!-- 	        <ul class="nav nav-pills pull-right">
 ...
 -->	        <h3 class="text-muted">Teamwork project</h3>
	    </div>
	    ...
	    <div class="footer">
	        <p><span class="glyphicon glyphicon-heart"></span>FINKI 2014-2015, mentor: Gjorgi Madjarov</p>
	    </div>
	</div>
	...
	<script src="scripts/controllers/fireController.js"></script>
